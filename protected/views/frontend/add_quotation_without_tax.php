...
if (isset($_POST['submit'])){
	...
	if ($empt_fields)
	{
       ...
       $insert=$db->insert('estimates',array('customer_id'=>$customer_id,
                                        ...
                                        //	 'total_tax'=>$total_tax,
                                    	     ...
                                    	     'created_date'=>$created_date, 'ip_address'=>$ip,'gst_registered'=>'no'));
	...
	if ($insert){
		...
		echo "<script>
                         setTimeout(function(){
        	    		  window.location = '".$link->link("selling_estimate",user)."'
        	                },3000);</script>";
	}
}
}
...
<div class="input_fields_wrap_selling_estimate">
    ...
    <div class="col-md-1"><input class="form-control" type="number" id="qty1" name="qty[]"></div>
...
$("#customer_id").change(function(){
	var id=$(this).val();
	location.href=window.location.pathname+'?user=add_quotation_without_tax&id='+id;
});
</script>