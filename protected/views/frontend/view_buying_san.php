 ...
 {
   $buying_san_id=$_REQUEST['action_view'];
   $buying_san_details=$db->get_row('supplier_adjustment_notes',array('id'=>$buying_san_id));
   $customer_detail=$db->get_row('contacts',array('id'=>$buying_san_details['supplier_id']));
  // $user=$db->get_row('users',array('user_id'=>$_SESSION['user_id']));

   $project=unserialize($buying_san_details['project_id']);
   $item=unserialize($buying_san_details['item_id']);
   $item_price=unserialize($buying_san_details['item_price']);
  // $item_description=unserialize($buying_san_details['item_description']);

   //print_r($item_description);


   $item_qty=unserialize($buying_san_details['item_qty']);
   $item_taxcode=unserialize($buying_san_details['taxcode']);
   $item_tax=unserialize($buying_san_details['tax']);
   $item_amount=unserialize($buying_san_details['amount']);
}

 ?>
  <div class="container-fluid main-content">
        <div class="page-title">
          <h1>Supplier adjustment note
          <button class="btn btn-primary pull-right" onclick="goBack()">
            <i class="fa fa-backward"></i> Go Back</button>
           <?php if(in_array('print',$dtd_supplier_adjustment_notes)){?>
            ...
            <div class="col-lg-12">
              <div class="row invoice-header">
                ...
                <div class="col-md-6 text-right">
                  <h2>
                    <?php echo "#".$buying_san_details['adjustment_number'];?>
                  </h2>
                 <p>
                  Adjustment note date: <?php echo $buying_san_details['adjustment_date'];?>
                  </p>
                    <p>
                   Reference code :
                     <?php
                   if($buying_san_details['reference_code']==""){
                       echo "N/A";
                   }
                   else
                   {
                      echo $buying_san_details['reference_code'];
                   }
                   ?>
                  ...
                  <p>
                   	<strong>Payment Status :</strong>
                   	  <?php echo ucfirst($buying_san_details['payment_status']);?>
                ...
                <div class="widget-content padded clearfix">
                  <table class="table table-striped invoice-table">
                    ...
                    <tr>
                      ...
                      <th width="10%">Qty</th>
                  <?php if ($buying_san_details['gst_registered']!='no'){?>
                    ...
                    <td></td>
                     ...
                     <tfoot>
                      <tr>
                        ...
                        <td >
                          <?php echo CURRENCY." ".number_format($buying_san_details['subtotal'],2,'.',',');?>
                        </td>
                      </tr>
                  <?php if ($buying_san_details['gst_registered']!='no'){?>
                      <tr>
                        ...
                        <td>
                        <?php echo CURRENCY." ".number_format($buying_san_details['total_tax'],2,'.',',');?>
                        </td>
                      </tr>
                  <?php }?>
                     <tr>
                        ...
                        <td>
                          <h4 class="text-primary">
                          <?php echo CURRENCY." ".number_format($buying_san_details['total_amount'],2,'.',',');?>
                          </h4>
                        </td>
                      </tr>
                    </tfoot>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="well">
                <strong>NOTES</strong>
                <p>
                 <?php echo $buying_san_details['notes'];?>
                </p>
              </div>
            </div>
          </div>
