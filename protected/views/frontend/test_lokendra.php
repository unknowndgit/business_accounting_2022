...
$all_ert=$db->run("SELECT* FROM `tax` WHERE `iras_for_gst_code`='TX7' OR  `iras_for_gst_code`='ZP'")->fetchAll();
...
<br>
    	...
    	<div class="widget-container fluid-height">
        	...
        	$html="<table style='width:100%;text-align:center;'>
					...
					FROM 4/1/2016 TO 6/30/2016</small>
                   </td></tr>
                    </table>";
...
$html.="<table style='width:100%'>
      ...
      $html.="</td></tr>";
       ...
       $html.="<tr>
                        <td>Box 9 : Total value of goods imported under under the MES/ A3PL/ Other Approved Schemes</td>
                        <td></td>
                       </tr>";
