                 ...
                 <div class="row">
                        ...
                        <div class="row">
							<div class="row tabs">
							    ...
							    <div class="col-md-2">Contact<font color="red">*</font></div>
						...
						<div class="tabs" style="height:30px;">
							...
							<div class="col-md-1"><?php echo CURRENCY;?>&nbsp;<span id="dr">  0.00 </span><input type="hidden" name="dr" id="dr_hidden"></div>
							<div class="col-md-1"><?php echo CURRENCY;?>&nbsp;<span id="cr">  0.00 </span><input type="hidden" name="cr" id="cr_hidden"></div>
						</div>
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="row">'+
				    ...
				    '<div class="col-md-1"><input class="form-control" type="text" name="narration[]"></div>'+
				    '<div class="col-md-2"><select class="form-control" name="contact[]" id="contact'+x+'" required><option value=""></option><?php if (is_array($all_contact)){foreach ($all_contact as $contacts){?><option value="<?php echo $contacts['id']?>"><?php echo $contacts['display_name']?></option><?php }}?></select></div>'+
