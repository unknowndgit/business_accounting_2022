   ...
   <a href="<?php echo $link->link('add_time_expense_claims',user);?>" class="btn btn-default pull-right"> Add </a>
	                  ...
	                  <div class="heading tabs">
	                    ...
	                    <ul class="nav nav-tabs pull-left" data-tabs="tabs">
	                      <li class="<?php if ($current_tab=="All" || $current_tab==""){echo"active";}?>">
	                        <a  href="<?php echo $link->link('time_expense_claims',user,'&tab=All');?>"><i class="icon-comments"></i><span>All</span></a>
	                      </li>
	                      <li class="<?php if ($current_tab=="Unpaid"){echo"active";}?>">
	                        <a  href="<?php echo $link->link('time_expense_claims',user,'&tab=Unpaid');?>"><i class="icon-user"></i><span>Unpaid</span></a>
	                      </li>
	                      <li class="<?php if ($current_tab=="Paid"){echo"active";}?>">
	                        <a  href="<?php echo $link->link('time_expense_claims',user,'&tab=Paid');?>"><i class="icon-user"></i><span>Paid</span></a>
	                      </li>
	                     </ul>
					              ...
					              <div class="widget-content padded clearfix">
					                <table class="table table-bordered table-striped" id="dataTable1">
					                  ...
					                  <tbody>
					                      ...
					                      <td class="hidden-xs">123 new</td>
					                        <td class="hidden-xs">Sydney Operations</td>
					                        <td class="hidden-xs">98.89</td>
					                        <td class="hidden-xs">98.89</td>
					                        <td class="hidden-xs">98.89</td>
					                    </tr>
					                      <tr>
