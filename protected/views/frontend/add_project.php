<?php if (isset($_POST['add_project_submit']))
{
	//print_r($_POST);
      ...
      /*  if(is_array($_POST['items'])){
        ...
        if(is_array($_POST['customer'])){
        	foreach ($_POST['customer'] as $key=>$value){
        		...
        		$insert=$db->insert('assign_customer_project',array('project_id'=>$last_id, 'visibility_status'=>$visibility_status, 'customer'=>$customer, 'weighting'=>$customer_weighting, 'created_date'=>$created_date, 'ip_address'=>$ip_address ));
        	}
        }
        if(is_array($_POST['supplier'])){
        	foreach ($_POST['supplier'] as $key=>$value){
        		...
        		$insert=$db->insert('assign_supplier_project',array('project_id'=>$last_id, 'visibility_status'=>$visibility_status, 'supplier'=>$supplier, 'weighting'=>$supplier_weighting, 'created_date'=>$created_date, 'ip_address'=>$ip_address ));
        	}
        }
...
// $db->debug();
      if ($insert){
          ...
          $event="Add new project  (" . $project_name . ")";
          ...
          <form action="#" class="form-horizontal" method="post">
               ...
               <h3>Add project &nbsp;&nbsp;&nbsp;<span class="label label-info">Status : Active</span>
                 <a href="<?php echo $link->link('project',user);?>" class="btn btn-default pull-right">Back to List</a>
                   ...
                   <a href="<?php echo $link->link('add_project',user);?>" class="btn btn-default pull-right">Cancel</a>
                    <button class="btn btn-primary pull-right" type="submit" name="add_project_submit"> Submit </button>
                 ...
                 <div class="widget-content padded">
                        ...
                        <div class="row">
                            ...
                            <input class="form-control" placeholder="" type="text" name="project_name" value="<?php echo $_POST['project_name'];?>">
                            </div>
							</div>
                            ...
                            <br>
                             ...
                             <div class="input-group date datepicker col-md-12" data-date-autoclose="true" data-date-format="dd-mm-yyyy">
                                       	 <input class="form-control" type="text" name="start_date" value="<?php if ($_POST['start_date']!=''){echo $_POST['start_date'];}else{echo date("d-m-Y");}?>"><span class="input-group-addon"><i class="lnr lnr-calendar-full "></i></span>
					        ...
					        <div class="form-group">
                             ...
                             <select class="form-control" name="visibility_status">
                                 <option value="active" <?php if ($_POST['active']=='active'){echo 'selected';}?>>Active</option>
                                 <option value="inactive" <?php if ($_POST['inactive']=='inactive'){echo 'selected';}?>>Inactive</option>
                              </select>
                            </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="input-group date datepicker col-md-12" data-date-autoclose="true" data-date-format="dd-mm-yyyy">
                                       	 <input class="form-control" type="text" name="end_date" value="<?php echo $_POST['end_date'];?>"><span class="input-group-addon"><i class="lnr lnr-calendar-full "></i></span>
                      ...
                      <!--<h5><strong>SUBPROJECT</strong></h5>  -->
                       <div class="row">
                            ...
                            <input class="form-control" placeholder="" type="text" name="description" value="<?php echo $_POST['description'];?>">
                            </div>
                               </div>
...
<?php $supl=$db->get_all('contacts',array('visibility_status'=>'active','is_supplier'=>'yes'));?>
<script>
$(document).ready(function() {
    var max_fields      = 10; //maximum input boxes allowed
