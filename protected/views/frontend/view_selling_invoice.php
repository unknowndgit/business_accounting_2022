 ...
 {
   $invoice_id=$_REQUEST['action_view'];
   $invoices_details=$db->get_row('invoices',array('id'=>$invoice_id));
   $customer_detail=$db->get_row('contacts',array('id'=>$invoices_details['customer_id']));
  // $user=$db->get_row('users',array('user_id'=>$_SESSION['user_id']));

   $project=unserialize($invoices_details['project_id']);
   $item=unserialize($invoices_details['item_id']);
   $item_price=unserialize($invoices_details['item_price']);
  // $item_description=unserialize($invoices_details['item_description']);

   //print_r($item_description);


   $item_qty=unserialize($invoices_details['item_qty']);
   $item_taxcode=unserialize($invoices_details['taxcode']);
   $item_tax=unserialize($invoices_details['tax']);
   $item_amount=unserialize($invoices_details['amount']);
}
        ...
        <div class="page-title">
          ...
          <button class="btn btn-primary pull-right" onclick="goBack()">
            <i class="fa fa-backward"></i> Go Back</button>
                <?php if(in_array('print_and_email',$dtd_invoice)){?>
            ...
            <div class="col-lg-12">
              <div class="row invoice-header">
                ...
                <div class="col-md-6 text-right">
                  <h2>
                    <?php echo "#".$invoices_details['invoice_number'];?>
                  </h2>
                 <p>
                  Invoice date: <?php echo $invoices_details['invoice_date'];?>
                  </p>
                    <p>
                   Reference code :
                  <?php
                   if($invoices_details['reference_code']==""){
                       echo "N/A";
                   }
                   else
                   {
                      echo $invoices_details['reference_code'];
                   }
                   ?>
                 </p>
                    <p>
                   Payment terms :
                    <?php
                   if($invoices_details['payment_term']==""){
                       echo "N/A";
                   }
                   else
                   {
                      echo $invoices_details['payment_term'];
                   }
                   ?>
                   ...
                   <p>
                     Due date :
                    <?php
                   if($invoices_details['due_date']==""){
                       echo "N/A";
                   }
                   else
                   {
                      echo $invoices_details['due_date'];
                   }
                   ?>

                  </p>
                  <p>
                   	<strong>Payment Status :</strong> <?php echo ucfirst($invoices_details['payment_status']);?>
                  </p>
                  </div>
              </div>
            </div>
                ...
                <div class="widget-content padded clearfix">
                  <table class="table table-striped invoice-table">
                    ...
                    <tr>
                      ...
                      <th width="10%">Qty</th>
                   <?php if ($invoices_details['gst_registered']!='no'){?>
                    ...
                    <td></td>
                     ...
                     <tfoot>
                      <tr>
                        ...
                        <td >
                          <?php echo CURRENCY." ".number_format($invoices_details['subtotal'],2,'.',',');?>
                        </td>
                      </tr>
                   <?php if ($invoices_details['gst_registered']!='no'){?>
                      <tr>
                        ...
                        <td>
                        <?php echo CURRENCY." ".number_format($invoices_details['total_tax'],2,'.',',');?>
                        </td>
                      </tr>
                    <?php }?>
                     <tr>
                        ...
                        <td>
                          <h4 class="text-primary">
                          <?php echo CURRENCY." ".number_format($invoices_details['total_amount'],2,'.',',');?>
                          </h4>
                        </td>
                      </tr>
                    </tfoot>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="well">
                <strong>NOTES</strong>
                <p>
                 <?php echo $invoices_details['notes'];?>
                </p>
              </div>
            </div>
          </div>
         <div class="row">
            <div class="col-lg-12">
              <div class="well">
                ...
                <p>
                 <?php echo $invoices_details['payment_notes'];?>
                </p>
              </div>
            </div>
          </div>
