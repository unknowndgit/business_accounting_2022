            ...
            <form action="" class="form-horizontal" method="post">
               ...
               <div class="widget-content padded">
                 <div class="row">
                        ...
                        <div class="row">
							<div class="row tabs">
							    <div class="col-md-2">Account<font color="red">*</font></div>
							...
							<div class="input_fields_wrap_selling_can">
					  			...
					  			<?php if (is_array($uns_account)){
								    ...
								    <!-- <div class="col-md-1">
								    	...
								    	<input class="form-control" type="hidden" name="tax_code1[]" id="tax_code1" >
								    </div> -->
								    <!-- <div class="col-md-1"><input class="form-control" type="text" name="tax[]" id="tax1" value="<?php echo $uns_tax[$key];?>"></div> -->
								    <div class="col-md-2"><input class="form-control" type="text" name="narration[]" value="<?php echo $uns_narration[$key];?>"></div>
								    <div class="col-md-1">
								    ...
								    <div class="col-md-1"><!-- <a href="#" id="remove_item<?php echo $key;?>" class="remove_field_selling_can btn btn-default">x</a> --></div><br><br>
									...
									<script>
							            ...
							            $("#remove_item<?php echo $key;?>").click(function(){
											...
											var cbt=parseFloat($('#credit'+res_id).val());
											var dbt=parseFloat($('#debit'+res_id).val());

											var dbt_tot=parseFloat($('#dr').html());
											var cbt_tot=parseFloat($('#cr').html());

											if(!isNaN(cbt)){
												var new_cbt = cbt_tot - cbt;
												$("#cr").html(new_cbt.toFixed(2));
											}
											if(!isNaN(dbt)){
												var new_dbt = dbt_tot - dbt;
												$("#dr").html(new_dbt.toFixed(2));
											}
							            });
							        </script>
						...
						<div class="tabs" style="height:30px;">
							...
							<div class="col-md-1"><?php echo CURRENCY;?> &nbsp;<span id="dr"> <?php echo array_sum($uns_debit);?> </span><input type="hidden" name="dr" id="dr_hidden"></div>
							<div class="col-md-1"><?php echo CURRENCY;?> &nbsp;<span id="cr"> <?php echo array_sum($uns_credit);?> </span><input type="hidden" name="cr" id="cr_hidden"></div>
						</div>
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="row">'+
            		'<div class="col-md-2"><select class="form-control" name="account[]" id="account'+x+'" required><option value="">select</option><?php if (is_array($all_account)){ foreach ($all_account as $accounts){ ?><option value="<?php echo $accounts['id'];?>"><?php echo $accounts['account_name'].' - '.$accounts['account_type'];?></option><?php }}?></select></div>'+
				    ...
				    '<div class="col-md-2"><input class="form-control" type="text" name="narration[]"></div>'+
